...
const mentorCourseController_1 = require("../../../adapters/controllers/mentorController/mentorCourseController");
...
// COURSE
mentorRoute.post("/add-course", multer_1.upload.array("images[]", 2), jwtTokenAuth_1.verifyToken, mentorCourseController_1.addCourse);
